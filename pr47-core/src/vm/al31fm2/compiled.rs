...
use crate::vm::al31fm2::Combustor;
...
#[cfg(feature = "async")] use crate::vm::al31fm2::{AL31F, AsyncCombustor};
...
pub struct CompiledProgram<A: Alloc> {
    ...
    #[cfg(feature = "async")]
    pub async_ffi_funcs: Box<[&'static dyn FFIAsyncFunction<AL31F<A>, AsyncCombustor<A>>]>
}
